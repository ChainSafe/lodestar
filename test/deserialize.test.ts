...
describe("deserialize", () => {
  const testCases: {
    ...
    {value: "deadbeef", type: "bytes8", expected: Buffer.from("deadbeef", "hex")},
    {value: "deadbeefdeadbeefdeadbeefdeadbeef", type: "bytes32", expected: Buffer.from("deadbeefdeadbeefdeadbeefdeadbeef", "hex")},
    {value: "deadbeef", type: "bytes", expected: Buffer.from("deadbeef", "hex")},
    {value: "deadbeef", type: ["byte",8],  expected: Buffer.from("deadbeef", "hex")},
    {value: "deadbeefdeadbeefdeadbeefdeadbeef", type: ["byte",32],  expected: Buffer.from("deadbeefdeadbeefdeadbeefdeadbeef", "hex")},
    {value: "deadbeef", type: ["byte"], expected: Buffer.from("deadbeef", "hex")},
    ...
    {value: "030600050700", type: [OuterObject], expected: [{v:3, subV:{v:6}}, {v:5, subV:{v:7}}]},
  ];
