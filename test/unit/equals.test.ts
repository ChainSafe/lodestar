...
describe("equals", () => {
  const testCases: {
    ...
    {value1: Buffer.from("abcd", "hex"), value2: Buffer.from("abcd", "hex"), type: "bytes", expected: true},
    ...
    {value1: [0,1,2,3,4,5], value2: [0,1,2,3,4,5], type: ["uint16"], expected: true},
    {value1: [0,1,2,3,4,6], value2: [0,1,2,3,4,5], type: ["uint16"], expected: false},
    {value1: [0,1,2,3,4,5], value2: [0,1,2,3,4,5], type: ["uint16", 6], expected: true},
    {value1: [0,1,2,3,4,6], value2: [0,1,2,3,4,5], type: ["uint16", 6], expected: false},
