...
describeDirectorySpecTest<IAltairStateTestCase, altairTypes.BeaconState>(
  "altair epoch effective balance updates minimal",
  join(SPEC_TEST_LOCATION, "tests/minimal/altair/epoch_processing/effective_balance_updates/pyspec_tests"),
  (testcase) => {
    ...
    altair.fast.processEffectiveBalanceUpdates(wrappedState as CachedBeaconState<allForks.BeaconState>, process);
    return wrappedState;
  },
  {
    inputTypes: {
