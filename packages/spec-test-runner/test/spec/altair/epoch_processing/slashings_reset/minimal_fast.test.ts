...
describeDirectorySpecTest<IAltairStateTestCase, altairTypes.BeaconState>(
  "altair epoch slashings reset minimal",
  join(SPEC_TEST_LOCATION, "tests/minimal/altair/epoch_processing/slashings_reset/pyspec_tests"),
  (testcase) => {
    ...
    fast.processSlashingsReset(wrappedState as CachedBeaconState<allForks.BeaconState>, process);
    return wrappedState;
  },
  {
    inputTypes: {
