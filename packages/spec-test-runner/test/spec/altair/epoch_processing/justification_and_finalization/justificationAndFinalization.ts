...
export function runJustificationAndFinalization(presetName: PresetName): void {
  ...
  describeDirectorySpecTest<IAltairStateTestCase, altairTypes.BeaconState>(
    `altair epoch justification and finalization ${presetName}`,
    join(SPEC_TEST_LOCATION, `tests/${presetName}/altair/epoch_processing/justification_and_finalization/pyspec_tests`),
    (testcase) => {
