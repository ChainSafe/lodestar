...
describeDirectorySpecTest<IAltairStateTestCase, altairTypes.BeaconState>(
  "altair epoch eth1 data reset minimal",
  join(SPEC_TEST_LOCATION, "tests/minimal/altair/epoch_processing/eth1_data_reset/pyspec_tests"),
  (testcase) => {
    ...
    fast.processEth1DataReset(wrappedState as CachedBeaconState<allForks.BeaconState>, process);
    return wrappedState;
  },
  {
    inputTypes: {
