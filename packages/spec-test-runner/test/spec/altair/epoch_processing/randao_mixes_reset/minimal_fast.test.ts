...
describeDirectorySpecTest<IAltairStateTestCase, altairTypes.BeaconState>(
  "altair epoch randao mixes reset minimal",
  join(SPEC_TEST_LOCATION, "tests/minimal/altair/epoch_processing/randao_mixes_reset/pyspec_tests"),
  (testcase) => {
    ...
    fast.processRandaoMixesReset(wrappedState as CachedBeaconState<allForks.BeaconState>, process);
    return wrappedState;
  },
  {
    inputTypes: {
