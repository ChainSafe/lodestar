...
} from "@chainsafe/lodestar-beacon-state-transition/lib/altair/fast/epoch/balance";
import {
...
describeDirectorySpecTest<RewardTestCase, Output>(
  "altair rewards random minimal",
  join(SPEC_TEST_LOCATION, "tests/minimal/altair/rewards/random/pyspec_tests"),
  (testcase) => {
