...
import {phase0, IStateContext, createCachedValidatorsBeaconState} from "@chainsafe/lodestar-beacon-state-transition";
...
describeDirectorySpecTest<IFinalityTestCase, BeaconState>(
  ...
  (testcase) => {
    ...
    let stateContext: IStateContext = {epochCtx, state: wrappedState};
