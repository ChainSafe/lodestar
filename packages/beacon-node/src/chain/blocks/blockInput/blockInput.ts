import {ForkName, ForkPostDeneb, ForkPostElectra, ForkPostFulu, ForkPreDeneb} from "@lodestar/params";
import {BlobIndex, SignedBeaconBlock, Slot, deneb, fulu} from "@lodestar/types";
