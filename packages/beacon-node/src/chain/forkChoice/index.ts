    ...
    ProtoArray.initialize(
      {
        ...
        builderIndex: isForkPostGloas ? state.latestExecutionPayloadBid.builderIndex : null,
        blockHashFromBid: isForkPostGloas ? toRootHex(state.latestExecutionPayloadBid.blockHash) : null,
