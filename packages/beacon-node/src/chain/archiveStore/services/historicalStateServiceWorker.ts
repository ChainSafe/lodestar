...
import {LodestarServiceWorker} from "../../../interface.js";
import {RegistryMetricCreator, collectNodeJSMetrics} from "../../../metrics/index.js";
import {JobFnQueue} from "../../../util/queue/fnQueue.js";
import {QueueMetrics} from "../../../util/queue/options.js";
import {HistoricalStateMetrics, HistoricalStateServiceApi, HistoricalStateServiceData} from "../interface.js";
import {getMetrics} from "../metrics/historicalStateMetrics.js";
import {DifferentialLayers} from "../utils/differentialLayers.js";
import {getHistoricalState, putHistoricalState} from "../utils/historicalState.js";

// most of this setup copied from networkCoreWorker.ts

const workerData = worker.workerData as HistoricalStateServiceData;
...
const diffLayers = new DifferentialLayers(workerData.diffLayers);
...
const historicalStateRegenMetrics: HistoricalStateMetrics | undefined = metricsRegister
...
const api: LodestarServiceWorker<HistoricalStateServiceApi> = {
  async close() {
