...
import {DifferentialArchiveStrategy, HistoricalStateMetrics, RegenErrorType} from "../interface.js";

export function getMetrics(metricsRegister: RegistryMetricCreator): HistoricalStateMetrics {
  return {
    ...
    regenTime: metricsRegister.histogram<{strategy: DifferentialArchiveStrategy}>({
