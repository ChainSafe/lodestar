...
export const PERSIST_TEMP_STATE_EVERY_EPOCHS = 32;
   ...
   * ```
   */
  export async function maybeArchiveState(modules: FrequentStateArchiveModules, opts: {archiveStateEpochFrequency: number}, finalized: CheckpointWithHex): Promise<void> {
