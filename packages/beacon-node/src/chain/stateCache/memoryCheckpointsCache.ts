...
/**
 * Old implementation of CheckpointStateCache that only store checkpoint states in memory
 *
 * Similar API to Repository
 */
export class MemoryCheckpointStateCache implements CheckpointStateCache {
