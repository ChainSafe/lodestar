...
export enum DataColumnStoreErrorCode {
  ...
  INVALID_OFFSET = "DATA_COLUMN_STORE_INVALID_OFFSET",
  ...
  NOT_INITIALIZED = "DATA_COLUMN_STORE_NOT_INITIALIZED",
}
...
export type DataColumnStoreErrorType =
  ...
  | {code: DataColumnStoreErrorCode.INVALID_OFFSET; slot: number; root: string; index: number}
