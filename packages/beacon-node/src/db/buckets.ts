...
export enum Bucket {
  ...
  gloas_executionPayloadEnvelope = 59, // GLOAS BeaconBlockRoot -> SignedExecutionPayloadEnvelope (unfinalized)
  gloas_executionPayloadEnvelopeArchive = 60, // GLOAS BeaconBlockSlot -> SignedExecutionPayloadEnvelope (finalized)
}
