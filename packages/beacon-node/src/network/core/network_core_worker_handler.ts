...
import {AsyncIterableBridgeCaller, AsyncIterableBridgeHandler} from "../../util/async_iterable_to_events.js";
import {wireEventsOnMainThread} from "../../util/worker_events.js";
...
export class WorkerNetworkCore implements INetworkCore {
  ...
  static async init(modules: WorkerNetworkCoreInitModules): Promise<WorkerNetworkCore> {
    ...
    const worker = new Worker("./network_core_worker.js", {workerData} as ConstructorParameters<typeof Worker>[1]);
