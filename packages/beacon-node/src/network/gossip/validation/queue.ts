...
const gossipQueueOpts: {[K in GossipType]: Pick<JobQueueOpts, "maxLength" | "type" | "maxConcurrency">} = {
  ...
  [GossipType.light_client_finality_update]: {maxLength: 1024, type: QueueType.FIFO}, //TODO DA revisit
  [GossipType.light_client_optimistic_update]: {maxLength: 1024, type: QueueType.FIFO}, //TODO DA revisit
};
