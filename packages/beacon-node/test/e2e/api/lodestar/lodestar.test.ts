...
describe("api / impl / validator", () => {
  ...
  describe("getLiveness endpoint", () => {
    ...
    it("Should return validator indices that are live", async () => {
      ...
      bn.chain.seenBlockProposers.add(0, 1, ZERO_HASH_HEX);
      ...
      bn.chain.seenBlockProposers.add(10, 1000, ZERO_HASH_HEX);
    ...
    it("Should return only for previous, current and next epoch", async () => {
      ...
      bn.chain.seenBlockProposers.add(bn.chain.clock.currentEpoch, 1, ZERO_HASH_HEX);
