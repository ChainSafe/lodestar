...
describe("computeGossipPeerScoreParams", () => {
  ...
  it("at genesis", () => {
    ...
    expect(gossipScoreThresholds.gossipThreshold).toEqual(-4000);
    expect(gossipScoreThresholds.publishThreshold).toEqual(-8000);
    expect(gossipScoreThresholds.graylistThreshold).toEqual(-16000);
    expect(gossipScoreThresholds.acceptPXThreshold).toEqual(100);
    expect(gossipScoreThresholds.opportunisticGraftThreshold).toEqual(5);
  ...
  function validateVoluntaryExitTopicParams(topics: Record<string, TopicScoreParams>): void {
    ...
    expect(params.topicWeight).toEqual(0.05);
    expect(params.timeInMeshWeight).closeTo(0.03333, TOLERANCE);
    expect(params.timeInMeshQuantum).toEqual(12 * 1000);
    expect(params.timeInMeshCap).toEqual(300);
    ...
    expect(params.invalidMessageDeliveriesWeight).closeTo(-2800, TOLERANCE);
  ...
  function validateSlashingTopicScoreParams(params: TopicScoreParams): void {
    ...
    expect(params.timeInMeshWeight).closeTo(0.03333, TOLERANCE);
    expect(params.timeInMeshQuantum).toEqual(12 * 1000);
    expect(params.timeInMeshCap).toEqual(300.0);
    ...
    expect(params.invalidMessageDeliveriesWeight).closeTo(-2800.0, TOLERANCE);
    expect(params.invalidMessageDeliveriesDecay).closeTo(0.99713, TOLERANCE);
  }
  ...
  function validateAggregateTopicParams(topics: Record<string, TopicScoreParams>, penaltiesActive: boolean): void {
    ...
    expect(params.topicWeight).toEqual(0.5);
    expect(params.timeInMeshWeight).closeTo(0.03333, TOLERANCE);
    expect(params.timeInMeshQuantum).toEqual(12 * 1000);
    expect(params.timeInMeshCap).toEqual(300.0);
    ...
    expect(params.invalidMessageDeliveriesWeight).closeTo(-280.0, TOLERANCE);
    expect(params.invalidMessageDeliveriesDecay).closeTo(0.99713, TOLERANCE);
    ...
    expect(params.meshFailurePenaltyWeight).closeTo(-0.95127, TOLERANCE);
    expect(params.meshFailurePenaltyDecay).closeTo(0.93057, TOLERANCE);

    if (penaltiesActive) {
      expect(params.meshMessageDeliveriesWeight).closeTo(-0.95127, TOLERANCE);
      ...
      expect(params.meshMessageDeliveriesThreshold).toEqual(0.0);
    }
  }
  ...
  function validateBlockTopicParams(topics: Record<string, TopicScoreParams>, penaltiesActive: boolean): void {
    ...
    expect(params.meshMessageDeliveriesActivation).toEqual(384 * 1000);
    expect(params.meshMessageDeliveriesWindow).toEqual(12 * 1000);
    expect(params.meshFailurePenaltyWeight).closeTo(-596.8696, TOLERANCE);
    expect(params.meshFailurePenaltyDecay).closeTo(0.97163, TOLERANCE);

    if (penaltiesActive) {
      expect(params.meshMessageDeliveriesWeight).closeTo(-596.8696, TOLERANCE);
  ...
  function validateAllAttestationSubnetTopicScoreParams(params: TopicScoreParams, penaltiesActive: boolean): void {
    expect(params.topicWeight).toEqual(0.015625);
    expect(params.timeInMeshWeight).closeTo(0.03333, TOLERANCE);
    expect(params.timeInMeshQuantum).toEqual(12 * 1000);
    expect(params.timeInMeshCap).toEqual(300.0);
    ...
    expect(params.invalidMessageDeliveriesWeight).closeTo(-8960.0, TOLERANCE);
    expect(params.invalidMessageDeliveriesDecay).closeTo(0.99713, TOLERANCE);
    ...
    expect(params.meshMessageDeliveriesWindow).toEqual(12 * 1000);
    expect(params.meshFailurePenaltyWeight).closeTo(-469.69001, TOLERANCE);
    expect(params.meshFailurePenaltyDecay).closeTo(0.96466, TOLERANCE);

    if (penaltiesActive) {
      expect(params.meshMessageDeliveriesWeight).closeTo(-469.69001, TOLERANCE);
...
function assertMessageRatePenaltiesDisabled(params: TopicScoreParams): void {
  expect(params.meshMessageDeliveriesWeight).toEqual(0.0);
  expect(params.meshMessageDeliveriesDecay).toEqual(0.0);
  expect(params.meshMessageDeliveriesThreshold).toEqual(0.0);
  expect(params.meshMessageDeliveriesCap).toEqual(0.0);
  expect(params.meshFailurePenaltyWeight).toEqual(0.0);
  expect(params.meshFailurePenaltyDecay).toEqual(0.0);
  expect(params.meshMessageDeliveriesActivation).toEqual(0);
  expect(params.meshMessageDeliveriesWindow).toEqual(0);
}
