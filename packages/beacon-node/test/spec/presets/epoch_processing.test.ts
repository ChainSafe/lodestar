...
/**
 * https://github.com/ethereum/consensus-specs/blob/v1.7.0-alpha.3/tests/formats/epoch_processing/README.md
 */
    ...
    return {
      testFunction: (testcase) => {
        ...
        if (testcase.post === undefined) {
          ...
          // https://github.com/ethereum/consensus-specs/blob/v1.7.0-alpha.3/tests/formats/epoch_processing/README.md#postssz_snappy
