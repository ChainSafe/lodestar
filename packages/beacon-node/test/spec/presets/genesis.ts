...
import {phase0, Root, ssz, TimeSeconds, allForks, eip4844} from "@lodestar/types";
    ...
    testFunction: (testcase) => {
      ...
      return initializeBeaconStateFromEth1(
        ...
        testcase["execution_payload_header"] &&
          executionPayloadHeaderType.toViewDU(testcase["execution_payload_header"] as eip4844.ExecutionPayloadHeader)
      );
    },
    // eth1.yaml
    // ```
