...
export const defaultSkipOpts: SkipOpts = {
  ...
  skippedTests: [
    ...
    /\/gloas_fork$/,
    /\/heze_fork$/,
    // TODO EIP-8148: this vector is generated by upgrade_to_eip8148 (pre=heze, post=eip8148 with
    // the new validator_sweep_thresholds field) but is placed under heze/fork by the generator.
    // Re-enable once eip8148 is implemented.
    /^heze\/fork\/fork\/pyspec_tests\/fork_base_state$/,
