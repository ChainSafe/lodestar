...
import * as altairDevnet0 from "./altair-devnet-0";

export type NetworkName = "mainnet" | "pyrmont" | "prater" | "dev" | "oonoonba" | "yeerongpilly" | "altair-devnet-0";
...
function getNetworkData(
  ...
  switch (network) {
    ...
    case "yeerongpilly":
      return yeerongpilly;
    case "altair-devnet-0":
      return altairDevnet0;
    default:
