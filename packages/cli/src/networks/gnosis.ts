...
export function getNetworkData(): NetworkData {
  return {
    ...
    depositContractDeployBlock: 19469077,
    genesisFileUrl: "https://raw.githubusercontent.com/gnosischain/configs/main/mainnet/genesis.ssz",
    bootnodesFileUrl: "https://raw.githubusercontent.com/gnosischain/configs/main/mainnet/bootnodes.yaml",
    bootEnrs: [
