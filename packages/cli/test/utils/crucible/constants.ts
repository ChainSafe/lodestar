...
export const EL_AND_CL_MNEMONIC =
  "focus future truly portion choose jealous donkey busy invest quantum bachelor flush sick burger wash motor veteran certain group clay cannon notable course despair";
