...
export let latestValidSignedAggregateAndProof: phase0.SignedAggregateAndProof;
...
export async function validateGossipAggregateAndProof(
  ...
  latestValidSignedAggregateAndProof = signedAggregateAndProof;
...
export async function validateGossipAggregateAndProofBatch(
  ...
  for (const signedAggregateAndProof of signedAggregateAndProofs) {
    const targetEpoch = signedAggregateAndProof.message.aggregate.data.target.epoch;
