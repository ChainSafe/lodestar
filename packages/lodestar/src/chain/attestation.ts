...
export class AttestationProcessor implements IAttestationProcessor {
  ...
  public async receiveAttestation(attestation: Attestation): Promise<void> {
    ...
    try {
      ...
      const state = this.db.stateCache.get(this.forkChoice.headStateRoot());
  ...
  public async processAttestation(attestation: Attestation, attestationHash: Root): Promise<void> {
    ...
    const checkpointState = this.db.stateCache.get(justifiedBlock.message.stateRoot.valueOf() as Uint8Array);
