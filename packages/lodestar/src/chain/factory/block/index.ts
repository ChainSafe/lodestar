...
import {CachedBeaconStateAllForks, processBlock} from "@chainsafe/lodestar-beacon-state-transition";
...
function computeNewStateRoot(
  ...
  processBlock(postState, block, {verifySignatures: false}, metrics);
