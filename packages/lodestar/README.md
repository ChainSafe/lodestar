...
Terminal 2:
`bin/lodestar dev --bootnodes "/ip4/127.0.0.1/tcp30306" --multiaddrs "/ip4/127.0.0.1/tcp/30307" -v 0 -r` - Will connect to bootnode (node 1 default multiaddrs) and won't start validators.
