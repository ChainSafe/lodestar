...
describe("syncing", function () {
  ...
  let chainStub: any, networkStub: any, dbStub: any, opPoolStub: any, logger: any;
  ...
  it("should receive attestation", async function () {
    ...
    dbStub.attestation.has.resolves(false);
    dbStub.state.getLatest.resolves(state);
    opPoolStub.attestations = new AttestationOperations(dbStub.attestation, dbStub.attestationData, {config});
