import {setActivePreset} from "@chainsafe/lodestar-params/setPreset";
import {ATTESTATION_SUBNET_COUNT, ForkName, PresetName, SLOTS_PER_EPOCH} from "@chainsafe/lodestar-params";
import sinon from "sinon";
import {SinonStubbedInstance} from "sinon";
import {createIChainForkConfig, createIForkConfig, IChainForkConfig} from "@chainsafe/lodestar-config";
...
describe("GossipPeerScoreParamsBuilder", function () {
  ...
  before(function () {
    ...
    // Teku tests is based on mainnet
    // process.env.LODESTAR_PRESET = "mainnet";
  });
  ...
  function validateAllAttestationSubnetTopicParams(topics: Record<string, TopicScoreParams>, penaltiesActive: boolean): void {
