...
import {FAR_FUTURE_EPOCH, ForkPostGloas, MIN_ACTIVATION_BALANCE, SLOTS_PER_EPOCH} from "@lodestar/params";
...
import {getCurrentEpoch, getRandaoMix, isActiveValidator} from "../util/index.js";
