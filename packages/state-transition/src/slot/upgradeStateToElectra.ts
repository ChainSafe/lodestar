...
export function upgradeStateToElectra(stateDeneb: CachedBeaconStateDeneb): CachedBeaconStateElectra {
  ...
  // stateElectraView.pendingDeposits = ssz.electra.PendingDeposits.defaultViewDU();
  // pendingDeposits, pendingPartialWithdrawals, pendingConsolidations are default  values
