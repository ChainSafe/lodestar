...
import {createFinalizedCachedBeaconState} from "../cache/stateCache.js";
...
export function initializeBeaconStateFromEth1(
  ...
  const state = createFinalizedCachedBeaconState(stateView, immutableData, {skipSyncCommitteeCache: true});
