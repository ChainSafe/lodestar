...
import {OutgoingPayload, PayloadType, TypeEncoder} from "../../types.js";
 ...
 */
function serializeSszBody<T>(chunk: OutgoingPayload<T>, type: TypeEncoder<T>): Buffer {
  switch (chunk.type) {
