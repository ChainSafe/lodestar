        ...
        forkChoiceNodes: [
          {
            ...
            blockRoot: rootHex,
            payloadStatus: "full",
            parentRoot: toHexString(new Uint8Array(32)),
            parentPayloadStatus: null,
            justifiedEpoch: 1,
            finalizedEpoch: 1,
            weight: 18_446_744_073_709_551_615n,
            validity: "valid",
            executionBlockHash: rootHex,
          ...
          {
            slot: 2,
            blockRoot: toHexString(new Uint8Array(32).fill(2)),
            ...
            payloadDataAvailabilityYesCount: 1,
            extraData: {client_field: {nested_value: "42"}},
          },
        ],
        extraData: {head_root: rootHex},
      },
    },
  },
  getProtoArrayNodes: {
