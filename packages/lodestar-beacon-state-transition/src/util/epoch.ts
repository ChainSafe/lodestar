 ...
 */
export function getCurrentEpoch(config: IBeaconConfig, state: phase0.BeaconState): Epoch {
 ...
 */
export function getPreviousEpoch(config: IBeaconConfig, state: phase0.BeaconState): Epoch {
