...
const typesByFork = {
  ...
  [ForkName.eip7805]: {...phase0Ssz, ...altairSsz, ...bellatrixSsz, ...capellaSsz, ...denebSsz, ...electraSsz, ...eip7805Ssz},
  [ForkName.fulu]: {...phase0Ssz, ...altairSsz, ...bellatrixSsz, ...capellaSsz, ...denebSsz, ...electraSsz, ...eip7805Ssz, ...fuluSsz},
};
