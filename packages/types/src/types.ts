...
export {ts as verkle} from "./verkle/index.js";
...
type TypesByFork = {
  ...
  [ForkName.verkle]: {
    BeaconBlockHeader: phase0.BeaconBlockHeader;
    SignedBeaconBlockHeader: phase0.SignedBeaconBlockHeader;
    BeaconBlock: verkle.BeaconBlock;
    BeaconBlockBody: verkle.BeaconBlockBody;
    BeaconState: verkle.BeaconState;
    SignedBeaconBlock: verkle.SignedBeaconBlock;
    Metadata: altair.Metadata;
    LightClientHeader: verkle.LightClientHeader;
    LightClientBootstrap: verkle.LightClientBootstrap;
    LightClientUpdate: verkle.LightClientUpdate;
    LightClientFinalityUpdate: verkle.LightClientFinalityUpdate;
    LightClientOptimisticUpdate: verkle.LightClientOptimisticUpdate;
    LightClientStore: verkle.LightClientStore;
    BlindedBeaconBlock: verkle.BlindedBeaconBlock;
    BlindedBeaconBlockBody: verkle.BlindedBeaconBlockBody;
    SignedBlindedBeaconBlock: verkle.SignedBlindedBeaconBlock;
    ExecutionPayload: verkle.ExecutionPayload;
    ExecutionPayloadHeader: verkle.ExecutionPayloadHeader;
    BuilderBid: verkle.BuilderBid;
    SignedBuilderBid: verkle.SignedBuilderBid;
    SSEPayloadAttributes: capella.SSEPayloadAttributes;
    SyncCommittee: altair.SyncCommittee;
    SyncAggregate: altair.SyncAggregate;
    Attestation: phase0.Attestation;
