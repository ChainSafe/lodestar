...
const {UintNum64, Root, BLSSignature, Slot, Bytes32, UintBn256, BLSPubkey} = primitiveSsz;
...
export const ExecutionWitness = new ContainerType(
  ...
  {
    typeName: "ExecutionWitness",
    casingMap: {stateDiff: "stateDiff", verkleProof: "verkleProof", parentStateRoot: "parentStateRoot"},
  }
);
...
export const ExecutionPayloadHeader = new ContainerType(
  {
    ...
    executionWitnessRoot: Root, // New in verkle
  },
...
export const BeaconBlockBody = new ContainerType(
  {
    ...
    executionPayload: ExecutionPayload, // Modified in verkle
...
export const BeaconBlock = new ContainerType(
  {
    ...
    body: BeaconBlockBody, // Modified in verkle
  },
...
export const SignedBeaconBlock = new ContainerType(
  {
    message: BeaconBlock, // Modified in verkle
...
export const BlindedBeaconBlockBody = new ContainerType(
  {
    ...altairSsz.BeaconBlockBody.fields,
    executionPayloadHeader: ExecutionPayloadHeader, // Modified in verkle
    blsToExecutionChanges: capellaSsz.BeaconBlockBody.fields.blsToExecutionChanges,
    // blobKzgCommitments: denebSsz.BlobKzgCommitments,
  },
...
export const BeaconState = new ContainerType(
  {
    ...
    // Execution
    latestExecutionPayloadHeader: ExecutionPayloadHeader, // Modified in verkle
    // Withdrawals
