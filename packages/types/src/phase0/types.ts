...
export type AttestationDataBytes8 = ValueOf<typeof ssz.AttestationDataBytes8>;
export type IndexedAttestation = ValueOf<typeof ssz.IndexedAttestation>;
export type IndexedAttestationBytes8 = ValueOf<typeof ssz.IndexedAttestationBytes8>;
