...
import {Checkpoint, Hash} from "@chainsafe/eth2.0-types";
...
["ssz_lengthy", "ssz_max", "ssz_nil", "ssz_one", "ssz_random", "ssz_random_chaos", "ssz_zero"].forEach((caseName) => {
  ...
  describeDirectorySpecTest<IBaseSSZStaticTestCase<Checkpoint>, IResult>(
    ...
    `${TEST_CASE_LOCATION}/tests/minimal/phase0/ssz_static/Checkpoint/${caseName}`,
    (testcase) => {
    ...
    },
    {
      ...
      // @ts-ignore
      sszTypes: {
        serialized: config.types.Checkpoint,
      },
