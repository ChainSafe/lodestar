...
import {AttesterSlashing, Hash} from "@chainsafe/eth2.0-types";
...
["ssz_lengthy", "ssz_max", "ssz_nil", "ssz_one", "ssz_random", "ssz_random_chaos", "ssz_zero"].forEach((caseName) => {
  ...
  describeDirectorySpecTest<BaseSSZStaticTestCase<AttesterSlashing>, Result>(
    ...
    },
    {
      ...
      // @ts-ignore
      sszTypes: {
        serialized: config.types.AttesterSlashing,
      },
