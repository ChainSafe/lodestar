...
import ethEstimateGasCase2 from "../../fixtures/mainnet/eth_estimateGas_contract_call.json" with {type: "json"};
import ethEstimateGasCase1 from "../../fixtures/mainnet/eth_estimateGas_simple_transfer.json" with {type: "json"};
