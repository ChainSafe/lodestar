...
import {phase0 as phase0Types} from "@chainsafe/lodestar-types";
import * as utils from "../../../../../src/util";
import {generateEmptyAttesterSlashing} from "../../../../utils/slashings";
import {phase0} from "../../../../../src/naive";
import {SinonStubFn} from "../../../../utils/types";

describe("process block - attester slashings", function () {
  const sandbox = sinon.createSandbox();
  let state: phase0Types.BeaconState, attesterSlashing: phase0Types.AttesterSlashing;
