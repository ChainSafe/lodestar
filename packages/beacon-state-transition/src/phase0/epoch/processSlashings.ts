...
import {EFFECTIVE_BALANCE_INCREMENT, PROPORTIONAL_SLASHING_MULTIPLIER} from "@chainsafe/lodestar-params";
...
export function processSlashings(state: CachedBeaconState<phase0.BeaconState>, process: IEpochProcess): void {
  ...
  const proportionalSlashingMultiplier = PROPORTIONAL_SLASHING_MULTIPLIER;
