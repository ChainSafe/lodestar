...
// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/transaction.yaml#L144
export type TransactionUnsignedAPI =
	| Transaction1559UnsignedAPI
	| Transaction2930UnsignedAPI
	| TransactionLegacyUnsignedAPI;

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/transaction.yaml#L211
export type TransactionSignedAPI =
	| Transaction1559SignedAPI
	| Transaction2930SignedAPI
	| TransactionLegacySignedAPI;

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/transaction.yaml#L216
...
// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/transaction.yaml#L244
export type TransactionWithSenderAPI = TransactionUnsignedAPI & { from: Address };

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/block.yaml#L2
...
// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/receipt.yaml#L2
export type LogAPI = LogBase<Uint, HexString32Bytes>;

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/receipt.yaml#L36
...
// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/client.yaml#L2
export type SyncingStatusAPI =
	| { startingBlock: Uint; currentBlock: Uint; highestBlock: Uint }
	| boolean;

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/fee_market.yaml#L42
export type FeeHistoryResultAPI = FeeHistoryBase<Uint>;

// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/schemas/filter.yaml#L2
...
export type EthExecutionAPI = {
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/block.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/transaction.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/client.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/execute.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/fee_market.yaml
	eth_gasPrice: () => Uint;
	eth_feeHistory: (
		blockCount: Uint,
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/filter.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/sign.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/state.yaml
	...
	// https://github.com/ethereum/execution-apis/blob/v1.0.0-beta.4/src/eth/submit.yaml
	eth_sendTransaction: (
		transaction: TransactionWithSenderAPI | Partial<TransactionWithSenderAPI>,
	) => HexString32Bytes;
