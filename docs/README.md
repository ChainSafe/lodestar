...
For Lodestar, some docs (CLI references, package READMEs/READMEs, etc.) are generated by a **repo-root** script (`pnpm docs:build`).

(Spellcheck note: "README" is a common project term and is included in the spellcheck wordlist.)
